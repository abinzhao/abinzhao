...
test("归档、标签、RSS 与旧写作路径来自真实公开文章", async ({
  ...
  await page.goto("/tags/HarmonyOS/");
  await expect(
  ...
  expect(await rss.text()).toContain(
    "https://abinzhao.github.io/blog/harmonyos-next-learning-path/",
  );
  ...
  expect(legacyHtml).toContain(
    '<link rel="canonical" href="https://abinzhao.github.io/blog/harmonyos-next-learning-path/">',
  );
  expect(legacyHtml).toContain(
    '<a href="/blog/harmonyos-next-learning-path/">立即跳转</a>',
  );
});
